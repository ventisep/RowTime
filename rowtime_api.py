...
STORED_TIMES = ObservedTimeList(event = "bedford regatta", last_key_sequence = 2, times= [
	ObservedTime(keysequence = 0, crew = 123, stage = 0, time = (2015,11,8,15,49,07,696869),
	ObservedTime(keysequence = 1, crew = 123, stage = 0, time = (2015,11,8,15,52,06,330000),
	ObservedTime(keysequence = 2, crew = 124, stage = 0, time = (2015,11,8,15,53,07,696869),
	ObservedTime(keysequence = 3, crew = 124, stage = 0, time = (2015,11,8,15,56,04,450000),
	ObservedTime(keysequence = 4, crew = 123, stage = 0, time = (2015,11,8,15,56,04,696869),
	ObservedTime(keysequence = 5, crew = 124, stage = 0, time = (2015,11,8,15,59,07,696869),
	ObservedTime(keysequence = 6, crew = 123, stage = 0, time = (2015,11,8,16,60,07,696869),
	ObservedTime(keysequence = 7, crew = 124, stage = 0, time = (2015,11,8,16,61,03,780000)])
